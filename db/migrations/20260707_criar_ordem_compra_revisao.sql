-- Sincroniza fornecedor no item e separa código da compra do código do modelo.
...
DECLARE
  ...
  v_codigo_pelo_fornecedor text := nullif(btrim(p_codigo_pelo_fornecedor), '');
